...
-- Log tiap scan dengan jarak vektor ke kandidat terdekat. Dipisahkan dari
-- biometric_attempts agar data eksperimen dapat dianalisis langsung.
...
CREATE INDEX idx_scan_logs_purpose ON scan_logs(purpose);
